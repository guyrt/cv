...
%
 ...
 \employer{1LineKeyboard Inc.}
 \location{Toronto, ON}
 \dates{January 2012 to present}
 \begin{position}
...
%Fluent: C, C++, Perl, Matlab, \LaTeX, Visual Basic

%Competent:  Java, R, SQL, Maple, ObjC

%Familiar: SAS, Bash Shell Script, HTML, CSS, XML
